...
------------------------------------
Computer side/Serial to Keyboard Driver

Listens for incoming serial data from the Arduino, and turns it into keyboard events.
See "SAIDprotocol.txt" or the README for more information on the data sent over serial.

------------------------------------
The keyboard emulation code used in SAID is shamelessly ripped from StackOverflow.
...
serialport = "COM6" #Change this to match your Arduino's virtual serial port
...
try:	
	...
	print("Serial connection on "+serialport+" was not found. Please confirm input device is on and connected.")
	sys.exit()	
		
		
	
print("Connected to Arduino at "+str(ser.baudrate)+" baud, "+serialport)
cinput = ""
prevup = 0
prevdown = 0
prevleft = 0
